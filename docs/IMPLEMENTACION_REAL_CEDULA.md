...
| 6. Viaje de ida | **Implementado** | Estación de verano con derrota por tramos, provisiones, demora, casco, velamen, moral, cohesión, información, formaciones, avisos, temporales, conserva, incorporación y combate táctico por línea, protección o evasión. | El combate es táctico por decisiones y valores, no acción naval en tiempo real. |
| 7. Tornaviaje | **Implementado** | Otoño de feria, invernada obligatoria en América, coste de carena y víveres, concentración del convoy y partida al abrirse la primavera; certificación mínima, Almiranta, formación, incidencias, pérdidas y liquidación. | El calendario se resume en cuatro estaciones jugables; la navegación astronómica se abstrae en rutas y sucesos. |
...
| 12. Miembros de la Compañía | **Implementado parcialmente** | Todo jugador comienza como mercader. Puede solicitar ingreso como miembro según buena fama/reputación y secreto; la membresía habilita la beneficencia. Filtrar secretos reduce riesgo; compartir noticias mejora diplomacia pero eleva amenaza. | Las mayorías y facciones se condensan en requisitos numéricos; no hay asamblea multijugador. |
...
| 14. Reforma, vigencia y derogación | **Implementado como regla de diseño** | Ninguna reforma se desbloquea por era: todas las normas seleccionadas operan simultáneamente. La fecha agregada del compendio se retiró de la interfaz para no presentarla como año de campaña. | No se simulan conflictos jurídicos entre textos; la Real Cédula del proyecto fija la regla compuesta. |
